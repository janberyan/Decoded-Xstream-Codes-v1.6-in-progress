...
echo file_get_contents('http://' . b8a6Ea05eEbc7e2e3503Ea794B1a1ee4::$StreamingServers[$D4b0e4f302fed4c8918d703be778a967]['server_ip'] . ':' . B8a6Ea05EEBc7E2E3503EA794B1A1ee4::$StreamingServers[$D4b0e4f302fed4c8918d703be778a967]['http_broadcast_port'] . '/api.php?action=viewDir&dir=' . $f0debd6e60de2f0ee2ce977c0ae36da4 . '&password=' . b8a6Ea05EEbc7E2E3503ea794B1A1ee4::$settings['live_streaming_pass']);
$c83b7d347a6bc7f5f0e3313147e88ecc->fA7E9FB747dD7976Dd94ea27FA865B5D();

echo '</ul>';

session_start();
$D4b0e4f302fed4c8918d703be778a967 = (!empty(B8A6Ea05eebC7e2E3503ea794B1A1ee4::$request['server']) && array_key_exists(B8A6eA05EEBc7E2E3503eA794B1A1ee4::$request['server'], b8A6Ea05eeBc7e2e3503Ea794b1A1Ee4::$StreamingServers) ? intval(B8A6ea05eeBc7E2e3503eA794b1A1EE4::$request['server']) : SERVER_ID);
