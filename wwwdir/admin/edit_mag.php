...
$b8393977a3619ac5c4541cda6dcccb12 = DFa6500b681f783BbBCb94474366Bb27::Ded78709C29E83eE9a7CBEeDaFc95035($Ae69657887d4ff7aed6dd09fc72a542e, NULL, NULL, true);
$Ae69657887d4ff7aed6dd09fc72a542e = false;

require (IPTV_TEMPLATES_PATH . '/' . '/admin/' . 'edit_mag.php');
...
case 'edit_mag':
	...
	$B55f78703213d1595283266f835ca867 = $f9a8823715bcb54e8069e0086da240b2['mag_device_edited'];
	...
	$a0b0150a772b6e518bbb5b40a3649f77 = (time() <= $b8393977a3619ac5c4541cda6dcccb12['user_info']['exp_date'] ? $a922b55f309483feb7cf56ee35c2c75b - time() : $a922b55f309483feb7cf56ee35c2c75b - $b8393977a3619ac5c4541cda6dcccb12['user_info']['exp_date']);
	...
	$b729e1e76a388ffdd6a130fbb0325a8e .= '  New Mac: ' . $a4e6e437f123785c5867b3e1ae39c5a8 . ' ';
	...
	$D29f3c5494cb370b46f3e907dc61f106->query('UPDATE `users` SET ' . "\r\n" . '                                                             `member_id` = \'%d\',' . "\r\n" . '                                                             `exp_date` = %s,' . "\r\n" . '                                                             `admin_notes` = \'%s\',' . "\r\n" . '                                                             `reseller_notes` = \'%s\',' . "\r\n" . '                                                             `allowed_ips` = \'%s\',' . "\r\n" . '                                                             `pair_id` = %s,' . "\r\n" . '                                                             `bouquet` = \'%s\',' . "\r\n" . '                                                             `is_trial` = \'%d\',' . "\r\n" . '                                                             `is_isplock` = \'%d\',' . "\r\n" . '                                                             `force_server_id` = \'%d\',' . "\r\n" . '                                                             `forced_country` = \'%s\' ' . "\r\n" . '                                                             WHERE `id` = \'%d\'', $d55019f4078483b70d22314f63b28b59, $a922b55f309483feb7cf56ee35c2c75b, $d72612f189fd647ca9cbf74b4ae7dc40, $A298f54616281708c1002e0c3f04e501, json_encode($ef60d74f311ef52f6bd7bb1517a2a04f), $e01cef000062cbd8f23e4f242a29229d, json_encode($c793d604f2518c7fa7180e274bef95d5), $D55e1ccfffb8f98ed27fb835d426cde2, $B8a7dad874c0e65b9e24f0081ce4c2c7, $A26347ec72cc7fc1587ce4ccf72a9293, $b39c1640f84f0655d3a0817379c8973e, $b8393977a3619ac5c4541cda6dcccb12['mag_device']['user_id']);

	$D29f3c5494cb370b46f3e907dc61f106->query('SELECT `username` FROM `reg_users` WHERE `id` = \'%d\'', $d55019f4078483b70d22314f63b28b59);

	$D29f3c5494cb370b46f3e907dc61f106->query('SELECT * FROM users WHERE `id` = \'%d\'', $e01cef000062cbd8f23e4f242a29229d);
	...
	$Ccc01a49a480ad4b98dc48415a5e29fa = $f9a8823715bcb54e8069e0086da240b2['selected_line_is_already_paired'];
	...
	$D29f3c5494cb370b46f3e907dc61f106->query('UPDATE `users` SET pair_id = NULL WHERE `id` = \'%d\'', $b8393977a3619ac5c4541cda6dcccb12['user_info']['pair_id']);
	...
	$Db68d51015ad0031e4c7f29d2b3a913c = $D29f3c5494cb370b46f3e907dc61f106->F46A3680C3d60298922076D7ff56BFca();
	...
	$b729e1e76a388ffdd6a130fbb0325a8e .= ' Notes Deleted ';
	$D29f3c5494cb370b46f3e907dc61f106->query('UPDATE `users` SET `pair_id` = \'%d\' WHERE `id` = \'%d\'', $b8393977a3619ac5c4541cda6dcccb12['mag_device']['user_id'], $e01cef000062cbd8f23e4f242a29229d);

	$C2aaac60d16a3fe3b99fcb0176fbe5d7 = b8a6EA05eebC7e2e3503EA794B1a1ee4::DAEB9fed37Cd1eC882B897C29F10f77e(10);
	if (($a4e6e437f123785c5867b3e1ae39c5a8 == $b8393977a3619ac5c4541cda6dcccb12['mag_device']['mac']) || !dbeb6A2d3Fdf653C03C41185A9d463C0('mag_devices', 'mac', $a4e6e437f123785c5867b3e1ae39c5a8)) {
	}

	$b729e1e76a388ffdd6a130fbb0325a8e .= ' New Admin Notes: ' . $d72612f189fd647ca9cbf74b4ae7dc40 . ' ';

	if (!($b8393977a3619ac5c4541cda6dcccb12['user_info']['is_trial'] != $D55e1ccfffb8f98ed27fb835d426cde2)) {
	}

	$b39c1640f84f0655d3a0817379c8973e = b8A6Ea05EEbC7E2e3503ea794B1A1ee4::$request['forced_country'];
	if (!($b8393977a3619ac5c4541cda6dcccb12['user_info']['reseller_notes'] != $A298f54616281708c1002e0c3f04e501)) {
	}

	$D29f3c5494cb370b46f3e907dc61f106->query('UPDATE `mag_devices` SET ' . "\r\n" . '                                                             `mac` = \'%s\'' . "\r\n" . '                                                              WHERE `mag_id` = \'%d\'', $a4e6e437f123785c5867b3e1ae39c5a8, $Ae69657887d4ff7aed6dd09fc72a542e);
...
default:
	...
	$Fce20624c9b6567a7a8c441a4651444d = $f9a8823715bcb54e8069e0086da240b2['mag_nexists'];
default:
default:
}

$Cecfa885eed4e0be5ea572f6a5e134a4 = C24A41ED39F4be3316a3ECB1884c6B23(array('is_mag' => 0));
