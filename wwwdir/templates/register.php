...
echo '</a></div>' . "\r\n" . '  ' . "\r\n" . '</div>' . "\r\n" . '<div class="pen-title">' . "\r\n" . '  ';
echo '</button>' . "\r\n" . '    </form>' . "\r\n" . '  </div>' . "\r\n" . '  <div class="cta"><a href="index.php?action=login">';
...
echo $f9a8823715bcb54e8069e0086da240b2['register'];
...
echo $f9a8823715bcb54e8069e0086da240b2['forgot'];
echo '" /></center>' . "\r\n" . '</div>' . "\r\n" . '<!-- Form Module-->' . "\r\n" . '<div class="module form-module">' . "\r\n" . '  ' . "\r\n" . '  <div class="form">' . "\r\n" . '    <h2>';
echo '</h2>' . "\r\n\t\t";

echo '    <form id="login" method="post" action="index.php?action=register">    ' . "\r\n" . '        <input type="text" autocomplete="off" name="login" placeholder="';

echo '" required>' . "\r\n" . '        <input type="password" autocomplete="off" name="pass_confirm" placeholder="';
...
echo '<span>' . B8a6ea05eEbC7E2e3503ea794B1A1eE4::$settings['copyrights_text'] . '</span>';
echo '</a></div>' . "\r\n" . '  <div class="cta"><a href="index.php?action=forgot">';
echo $f9a8823715bcb54e8069e0086da240b2['confirm_password'];
echo '</div>    ' . "\r\n" . '  </body>' . "\r\n" . '</html>' . "\n";
